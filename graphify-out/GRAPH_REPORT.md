# Graph Report - shiftech-test-mgr  (2026-08-10)

## Corpus Check
- 816 files · ~371,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4628 nodes · 11260 edges · 331 communities (271 shown, 60 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 986 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e8ab0363`
...
2. `react` - 75 edges
3. `writeSession()` - 73 edges
4. `call()` - 73 edges
5. `useAuthContext()` - 71 edges
6. `writeReg()` - 44 edges
...
## Communities (331 total, 60 thin omitted)

### Community 0 - "Test Run Repository (MySQL+Postgres)"
Cohesion: 0.08
Nodes (43): App(), IssueEditor(), AppToast(), Breadcrumb(), BreadcrumbItem, BreadcrumbProps, ColumnHeaderMenu(), ColumnHeaderMenuProps (+35 more)
...
Cohesion: 0.13
Nodes (33): contextKey, FromContext(), Context, Load(), LoadFromToken(), T, TestAssertProjectReferences_ArrayElements(), TestAssertProjectReferences_CamelCaseMatch() (+25 more)
...
Cohesion: 0.09
Nodes (19): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ProfileViewProps, makeProfile(), renderProfileView(), ProfileViewSkeleton() (+11 more)
...
Cohesion: 0.05
Nodes (35): IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), member(), profile() (+27 more)
...
Cohesion: 0.09
Nodes (37): BulkActionsBar(), BulkActionsBarProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps (+29 more)

### Community 20 - "Backend Test Plan Repository (MySQL)"
Cohesion: 0.15
Nodes (14): Context, DB, Next(), isDuplicateKeyErr(), fromDomainTestPlan(), Context, DB, TestPlan (+6 more)
...
Cohesion: 0.09
Nodes (33): UserHoverCard(), UserHoverCardProps, STATUS_OPTIONS, IssueDetailPageSkeleton(), PRIORITY_OPTIONS, TestCaseDetailPageSkeleton(), StartTestRunDialog(), StartTestRunDialogProps (+25 more)

### Community 25 - "Backend Test Run HTTP Layer"
Cohesion: 0.21
Nodes (9): FromTestRun(), FromTestRuns(), TestRun, Context, TestRunHandler, Service, NewTestRunHandler(), OK() (+1 more)

### Community 26 - "Frontend Test Plan UI"
Cohesion: 0.12
Nodes (18): CreateProjectDialogProps, DuplicateProjectDialogProps, createMockProjectRepository(), projectRepositoryAdapter, projectRepositoryAdapter, REST_API_URL, RestProjectDTO, projectRepositoryAdapter (+10 more)

### Community 27 - "Backend Test Plan Repository (Postgres)"
Cohesion: 0.10
Nodes (25): mapApiTokenRow(), buildMcpSetupPrompt(), buildUsagePromptStarters(), MCP_AGENT_TARGET_OPTIONS, McpAgentTarget, PromptParams, setupSteps(), UsagePromptStarter (+17 more)
...
Cohesion: 0.09
Nodes (20): renderTabParam(), TABS, useTabQueryParam(), MintRunnerTokenDialog(), ModuleDialog(), ModuleDialogProps, TagDialog(), TagDialogProps (+12 more)
...
Cohesion: 0.15
Nodes (29): supabase, mapActivityEntryRow(), mapAttachmentRow(), mapExternalLinks(), mapIssueRow(), mapModuleRow(), mapNotificationRow(), mapProfileRow() (+21 more)
...
Cohesion: 0.09
Nodes (31): RelativeTime(), RelativeTimeProps, ONE_MIN_AGO, describeSystemEvent(), EVENT_TYPE_LABEL, eventTypeLabel(), STATUS_LABEL_BY_ENTITY, statusLabel() (+23 more)
...
Cohesion: 0.12
Nodes (18): FromTestRole(), FromTestRoles(), TestRole, Time, Context, Service, NewTestRoleHandler(), CreateTestRoleRequest (+10 more)
...
Cohesion: 0.21
Nodes (21): T, newFakeRepo(), TestService_Latency_ClampedToZero(), TestService_WithRateLimit_IgnoresZero(), TestService_WithRateLimit_Overrides(), TestService_Wrap_AllHandlersGoverned(), TestService_Wrap_Allowed(), TestService_Wrap_BeginError() (+13 more)
...
Cohesion: 0.09
Nodes (4): createMockTestSuiteRepository(), TestSuiteRepository, TestSuiteItem, TestSuiteItemStep
...
Cohesion: 0.15
Nodes (16): NotFound(), Context, DB, NewProjectMemberRepository(), fromDomainProfile(), Context, DB, Profile (+8 more)
...
Cohesion: 0.10
Nodes (39): TestPlanStatus, Time, ActivityEntry, AnalysisProblematicResult, AnalysisRunSummary, AutomationJob, AutomationJobStatus, AutomationRunner (+31 more)
...
Cohesion: 0.05
Nodes (53): AdminRoute(), ProtectedRoute(), queryKeys, AuthContext, AuthProvider(), useAuthContext(), useDashboard(), useProjectAccessGuard() (+45 more)

### Community 75 - "Backend Test Run DB Model (MySQL)"
Cohesion: 0.20
Nodes (9): T, TestPlanStatus, TestPlan, TestPlanStatus, TestTestPlanServiceCreateAddRemoveApprove(), CreateTestPlanInput, PageResult, TestPlanFilter (+1 more)
...
Cohesion: 0.13
Nodes (11): TestRunStatus, TestRun, TestRun, TestTestRunServiceCreateRecordComplete(), CreateTestRunInput, RecordResultInput, RunSummary, TestRunFilter (+3 more)
...
Cohesion: 0.25
Nodes (5): createMockModuleRepository(), moduleRepositoryAdapter, moduleRepositoryAdapter, ModuleRepository, Module

### Community 90 - "Backend Project DB Model (MySQL)"
Cohesion: 0.07
Nodes (46): ProfileView(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_LABEL, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_LABEL (+38 more)
...
Cohesion: 0.15
Nodes (15): mapAutomationRunnerRow(), useAutomationRunners(), AutomationRunnersTab(), AutomationRunnersTabProps, StatusTag(), automationRunnerRepositoryAdapter, createMockAutomationRunnerRepository(), automationRunnerRepositoryAdapter (+7 more)
...
Cohesion: 0.22
Nodes (9): nonNilLinks(), Context, DB, TestCase, TestCaseStep, NewTestCaseRepo(), newUUID(), externalLinks (+1 more)
...
Cohesion: 0.09
Nodes (11): dashboardRepositoryAdapter, createMockDashboardRepository(), dashboardRepositoryAdapter, ContinueWorkingItem, DashboardCounts, DashboardRepository, MyWorkIssue, TestPlanCreateInput (+3 more)
...
Cohesion: 0.15
Nodes (11): CallToolRequest, CallToolResult, Context, ToolAdder, EnsureWriteScope(), TokenScope, AnalysisTools, Registry (+3 more)
...
Cohesion: 0.11
Nodes (22): StepType, TestCasePriority, TestCaseStatus, TestCase, TestTestCaseServiceUpdateDuplicateArchive(), ActivityRepository, AttachmentRepository, CreateTestCaseInput (+14 more)
...
Cohesion: 0.12
Nodes (16): ActivityEntry, Context, Issue, Module, Profile, Project, Tag, CreateActivityInput (+8 more)
...
Cohesion: 0.08
Nodes (21): IssueStatus, ActivityEntry, Context, Issue, IssueStatus, Profile, TestCase, TestPlan (+13 more)
...
Cohesion: 0.19
Nodes (13): CallToolRequest, CallToolResult, Context, ToolAdder, issueRef(), validIssuePriority(), validLimit(), validPriority() (+5 more)

### Community 146 - "projectDuplicateService.test.ts"
Cohesion: 0.10
Nodes (10): TestCaseDetail, makeTestCase(), nextId(), TestCaseRepository, makeTestCase(), makeTestCaseWithDetails(), TestCase, TestCaseWithDetails (+2 more)
...
Cohesion: 0.23
Nodes (15): isUUID(), strPtrIfNonEmpty(), boolLiteral(), decodeCaseBatch(), CallToolRequest, CallToolResult, Context, TokenScope (+7 more)
...
Cohesion: 0.13
Nodes (9): iconForType(), NOTIFICATION_TYPE_ICON, NotificationPanel(), NotificationPanelProps, createMockNotificationRepository(), notificationRepositoryAdapter, notificationRepositoryAdapter, NotificationRepository (+1 more)

### Community 169 - "main"
Cohesion: 0.39
Nodes (5): Context, TestRole, NewTestRoleService(), TestRoleService, TestRoleRepository

### Community 170 - ".Create"
Cohesion: 0.36
...
### Community 173 - "AccessRepository"
Cohesion: 0.29
...
Cohesion: 0.15
Nodes (10): createMockTestResultRepository(), sampleResult, sampleResultWithSteps, testResultRepositoryAdapter, testResultRepositoryAdapter, TestResultRepository, TestResult, TestResultStep (+2 more)
...
Cohesion: 0.24
Nodes (7): Context, NotificationRepository, NewNotificationService(), CreateNotificationInput, mockNotificationRepo, NotificationService, writeMockNotificationRepo

### Community 243 - "TestSuiteItemDialog.tsx"
Cohesion: 0.12
Nodes (15): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS, TestSuiteItemDialog(), TestSuiteItemDialogMode, TestSuiteItemDialogProps (+7 more)

### Community 244 - "@types/react-dom"
Cohesion: 0.11
Nodes (18): AttachmentPanelProps, createDataSourceResolver(), DataSourceName, entityAttachmentRepositoryAdapter, createMockEntityAttachmentRepository(), createMockProjectMemberRepository(), createMockTestCaseRepository(), createMockTestPlanRepository() (+10 more)

### Community 245 - "RefreshTokenRepository"
Cohesion: 0.33
Nodes (5): Context, DB, RefreshToken, NewRefreshTokenRepository(), RefreshTokenRepository

### Community 246 - "dto/testrun.go"
Cohesion: 0.18
...
Cohesion: 0.23
Nodes (5): createMockTestRoleRepository(), testRoleRepositoryAdapter, testRoleRepositoryAdapter, TestRoleRepository, TestRole
...
### Community 258 - "main"
Cohesion: 0.24
Nodes (10): authenticateRequest(), governanceInt(), governanceLimit(), governanceWindow(), main(), Context, DB, NewNotificationRepo() (+2 more)
...
Cohesion: 0.43
Nodes (7): MCPServer, ToolAdder, governanceInt(), governanceLimit(), governanceWindow(), main(), toolAdder()

### Community 267 - "RequireAuth"
Cohesion: 0.27
Nodes (4): validTestPlanStatus(), Context, TestPlanHandler, TestPlanStatus

### Community 268 - "TestPlanService"
Cohesion: 0.26
...
Cohesion: 0.27
Nodes (4): Session, TokenScope, Context, fakeResolver

### Community 286 - "HealthHandler"
Cohesion: 0.24
Nodes (6): validIssueStatus(), Context, IssueHandler, IssueStatus, issueAssignReq, issueUpdateStatusReq
...
### Community 292 - "read_tools_test.go"
Cohesion: 0.39
...
### Community 326 - "rest-api/cmd/main.go"
Cohesion: 0.13
Nodes (13): Context, DB, Time, NewAttachmentRepo(), AttachmentRepository, Context, NewAttachmentService(), AttachmentInfo (+5 more)

### Community 327 - "T"
Cohesion: 0.21
Nodes (4): createMockProfileRepository(), profileRepositoryAdapter, profileRepositoryAdapter, ProfileRepository

### Community 328 - "response.go"
Cohesion: 0.50
...
## Knowledge Gaps
- **624 isolated node(s):** `FilterToolbarProps`, `UseTableHeightOptions`, `$schema`, `.opencode/plugins/graphify.js`, `ProjectRepository` (+619 more)
...
- **Why does `As()` connect `AppTopbar.tsx` to `NewRouter`, `ResultStep`, `Backend Test Plan Repository (MySQL)`, `Backend Tag Repository (Postgres)`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `RepoService` connect `Backend Tag Repository (Postgres)` to `Project`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Internal()` connect `Backend Issue Domain & Service` to `Frontend Issue Management UI`, `Backend Profile Repository`, `Backend Test Plan Repository (MySQL)`, `Backend Issue Repository (Postgres)`, `.Update`, `.Update`, `Backend Test Case Repository (MySQL)`, `.Create`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `Backend Project Membership & Auth Policy`, `Backend JWT & Auth Service`, `Backend Attachment Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `.List`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `Recover`, `Backend Test Plan DB Model (MySQL)`, `AppTopbar.tsx`, `ResultStep`, `RefreshTokenRepository`, `NewRouter`, `AutomationTools`?**
...
- **What connects `FilterToolbarProps`, `UseTableHeightOptions`, `$schema` to the rest of the system?**
