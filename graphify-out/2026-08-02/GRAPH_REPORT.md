...
## Summary
- 3924 nodes · 9777 edges · 339 communities (226 shown, 113 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 824 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `131fa7db`
...
## Communities (339 total, 113 thin omitted)
...
Cohesion: 0.22
Nodes (13): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), isDesktop(), LayoutContext, LayoutContextValue, LayoutProvider() (+5 more)
...
Cohesion: 0.05
Nodes (50): App(), AdminRoute(), ProtectedRoute(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS (+42 more)
...
Cohesion: 0.06
Nodes (64): TestSuiteDialog(), Breadcrumb(), BreadcrumbProps, BulkActionsBar(), BulkActionsBarProps, ColumnHeaderMenu(), ColumnHeaderMenuProps, dataTablePaginatorProps (+56 more)
...
Cohesion: 0.20
Nodes (9): computeSummary(), Context, Repository, Summary, TestCaseRepository, TestRun, NewService(), Service (+1 more)

### Community 19 - "Frontend Project Management UI"
Cohesion: 0.08
Nodes (27): BreadcrumbItem, useProjectAccessGuard(), ownerProfile, renderItems(), useProjectBreadcrumbItems(), otherProfile, renderOwner(), useProjectOwnerProfile() (+19 more)
...
Cohesion: 0.07
Nodes (59): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), memberSelectLabel() (+51 more)
...
Cohesion: 0.09
Nodes (22): ProfileViewProps, makeProfile(), renderProfileView(), CreateProjectDialogProps, DuplicateProjectDialogProps, createMockProjectRepository(), projectRepositoryAdapter, projectRepositoryAdapter (+14 more)

### Community 27 - "Backend Test Plan Repository (Postgres)"
Cohesion: 0.06
Nodes (30): mapApiTokenRow(), buildMcpSetupPrompt(), MCP_AGENT_TARGET_OPTIONS, McpAgentTarget, PromptParams, setupSteps(), useApiTokens(), ACCESS_LEVEL_OPTIONS (+22 more)

### Community 28 - "Backend Issue Repository (Postgres)"
Cohesion: 0.20
Nodes (10): Context, DB, NewTestCaseSnapshotRepository(), NewTestPlanCaseReader(), TestCaseSnapshotRepository, TestPlanCaseReader, Repository, TestCaseRepository (+2 more)
...
Cohesion: 0.16
Nodes (26): mapActivityEntryRow(), mapAttachmentRow(), mapExternalLinks(), mapIssueRow(), mapModuleRow(), mapNotificationRow(), mapProfileRow(), mapProjectMemberInvitationRow() (+18 more)
...
Cohesion: 0.07
Nodes (35): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, queryKeys, useTestPlanDetail(), EMPTY_SUMMARY, Summary, TestRunWithSummary (+27 more)

### Community 38 - "Backend Test Run DTO"
Cohesion: 0.11
Nodes (24): RelativeTime(), RelativeTimeProps, ONE_MIN_AGO, describeSystemEvent(), EVENT_TYPE_LABEL, eventTypeLabel(), STATUS_LABEL_BY_ENTITY, statusLabel() (+16 more)

### Community 39 - "Backend Module HTTP DTO"
Cohesion: 0.13
Nodes (18): FromModule(), FromModules(), Module, Time, Service, NewAttachmentHandler(), Context, Service (+10 more)
...
Cohesion: 0.15
Nodes (16): isDuplicateKeyErr(), fromDomainProject(), Context, DB, Project, Query, Status, NewProjectRepository() (+8 more)
...
Cohesion: 0.33
Nodes (7): FromAttachment(), FromAttachments(), Attachment, Time, Context, AttachmentResponse, CreateAttachmentRequest
...
Cohesion: 0.09
Nodes (9): MockDashboardSeed, createMockTestSuiteRepository(), testSuiteRepositoryAdapter, testSuiteRepositoryAdapter, TestSuiteRepository, TestSuite, TestSuiteItem, TestSuiteItemStep (+1 more)
...
Cohesion: 0.26
Nodes (10): assertContained(), assertRepoRevision(), gitCredentialEnv(), Context, NewRepoService(), safeRepoURL(), validateRepoLimit(), ProjectRepositoryConfig (+2 more)
...
Cohesion: 0.10
Nodes (22): T, TestTestRunServiceCreateRecordComplete(), Context, NewTestRunService(), CreateTestRunInput, ModuleRepository, PageResult, ProjectRepository (+14 more)
...
Cohesion: 0.21
Nodes (8): Context, DB, TestPlan, Time, NewTestPlanRepo(), testPlanCaseRow, TestPlanRepo, testPlanRow
...
Cohesion: 0.23
Nodes (10): Time, TestResultStep, toDomainTestResultStep(), TestResultStep, toDomainTestResultStep(), ResultStep, Status, StepStatus (+2 more)

### Community 89 - "Backend Module DB Model (MySQL)"
Cohesion: 0.24
Nodes (7): Context, NewAttachmentService(), AttachmentInfo, AttachmentRepository, AttachmentService, mockAttachmentRepo, writeMockAttachmentRepo

### Community 90 - "Backend Project DB Model (MySQL)"
Cohesion: 0.06
Nodes (50): ParsedTestCaseRow, ISSUE_STATUS_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY, PROJECT_MEMBER_STATUS_LABEL, PROJECT_MEMBER_STATUS_SEVERITY, PROJECT_STATUS_LABEL, PROJECT_STATUS_SEVERITY (+42 more)
...
Cohesion: 0.08
Nodes (15): createDataSourceResolver(), DataSourceName, issueRepositoryAdapter, createMockIssueRepository(), createMockTestRoleRepository(), createMockTestRunRepository(), sampleRun, TestRunSeed (+7 more)
...
Cohesion: 0.11
Nodes (19): Context, DB, Time, NewIssueRepo(), CreateIssueInput, ExternalLink, Issue, IssueFilter (+11 more)

### Community 97 - "Backend Tag DB Model (Postgres)"
Cohesion: 0.24
Nodes (8): Context, DB, TestCase, TestCaseStep, NewTestCaseRepo(), newUUID(), externalLinks, TestCaseRepo
...
Cohesion: 0.26
Nodes (7): TestResult, toDomainTestResult(), TestResult, toDomainTestResult(), Result, ResultStatus, TestCaseSnapshot
...
Cohesion: 0.31
Nodes (9): governanceInt(), governanceLimit(), governanceWindow(), main(), toolAdder(), DB, NewActivityRepo(), MCPServer (+1 more)
...
Cohesion: 0.26
Nodes (5): supabase, testRoleRepositoryAdapter, StorageAdapter, UploadedFile, supabaseStorageAdapter
...
Cohesion: 0.19
Nodes (9): Context, TestTestPlanServiceCreateAddRemoveApprove(), CreateActivityInput, Module, Tag, mockActivityRepo, mockModuleRepo, mockTagRepo (+1 more)
...
Cohesion: 0.10
Nodes (21): Context, Context, NewActivityService(), derefProfile(), Context, NewIssueService(), normalizeIssueCode(), Context (+13 more)
...
Cohesion: 0.21
Nodes (14): T, TestIsUUID(), TestValidIssueStatus(), TestValidLimit(), TestValidPriority(), TestValidResultStatus(), TestValidRunStatus(), TestValidTestCaseStatus() (+6 more)
...
Cohesion: 0.21
Nodes (11): AppMenu(), EnrichedProject, AppMenuitem(), AppMenuSeparator(), MenuItemModel, OwnerProjectLabel(), OwnerProjectLabelProps, truncate() (+3 more)
...
Cohesion: 0.21
Nodes (11): validStepType(), TestTestCaseServiceUpdateDuplicateArchive(), CreateTestCaseInput, StepType, TestCase, TestCaseFilter, TestCasePriority, TestCaseStatus (+3 more)
...
Cohesion: 0.21
Nodes (12): AppTopbar(), getUserInitial(), pathForNotification(), BreadcrumbContext, BreadcrumbContextValue, BreadcrumbItem, BreadcrumbProvider(), useBreadcrumbContext() (+4 more)
...
Cohesion: 0.12
Nodes (21): Time, Context, DB, Project, Time, NewProjectRepo(), Project, ProjectFilter (+13 more)
...
Cohesion: 0.18
Nodes (10): Validation(), Context, HTTPErrorHandler(), httpMessage(), NoContent(), OKWithMeta(), statusFor(), HTTPError (+2 more)
...
Cohesion: 0.17
Nodes (8): Context, CreateTestPlanInput, TestPlan, TestPlanFilter, TestPlanStatus, writeMockActivityRepo, writeMockProfileRepo, writeMockTestPlanRepo
...
Cohesion: 0.32
Nodes (4): iconForType(), NOTIFICATION_TYPE_ICON, NotificationPanel(), NotificationPanelProps
...
Cohesion: 0.25
Nodes (4): Time, activityRow, jsonbMap, Value
...
## Knowledge Gaps
- **465 isolated node(s):** `0. Prasyarat: `DATABASE_URL``, `Menjalankan REST API`, `Env var per mode`, `Membuat token dulu`, `Jalankan server` (+460 more)
...
- **Why does `Internal()` connect `Backend Issue Domain & Service` to `.Update`, `Frontend Repository/Mapper Layer`, `Test Run Repository (MySQL+Postgres)`, `useRealtimeSync.ts`, `Created`, `Backend Profile Repository`, `Recover`, `Backend Test Plan Repository (MySQL)`, `Backend Issue Repository (Postgres)`, `Backend Google OAuth Service`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `Backend Project Membership & Auth Policy`, `Backend JWT & Auth Service`, `Backend Test Role Repository (MySQL)`, `Backend Attachment Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `Backend HTTP Response Helpers`, `Recover`, `Backend Test Plan DB Model (MySQL)`, `Backend Attachment DB Model (MySQL)`, `ResultStep`, `MentionTextarea.tsx`, `AutomationTools`?**
...
- **Why does `react` connect `Frontend Test Run/Plan Detail UI` to `test-plans/components/dialogs/DuplicateTestPlanDialog.tsx`, `Backend Test Case Repository (MySQL)`, `Frontend Lint Config`, `Frontend Issue Management UI`, `Frontend App Layout & Theme`, `Frontend Auth & User Settings`, `Backend Test Run DTO`, `Frontend CSV Import`, `Recover`, `Frontend Project Management UI`, `test-plans/components/dialogs/DuplicateTestPlanDialog.tsx`, `Frontend Test Suite UI`, `Backend Issue Repository (MySQL)`, `Backend Project DB Model (MySQL)`, `Backend Test Plan Repository (Postgres)`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
...
- **What connects `0. Prasyarat: `DATABASE_URL``, `Menjalankan REST API`, `Env var per mode` to the rest of the system?**
