...
// sortColumn mirrors frontend/src/repositories/projectRepository.ts's
// SORT_COLUMN map — same field-name -> column mapping, MySQL LIKE takes the
// place of Postgres ILIKE (MySQL's default utf8mb4_unicode_ci collation is
// already case-insensitive, see migration comments).
