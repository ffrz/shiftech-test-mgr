...
## Summary
- 4628 nodes · 11261 edges · 321 communities (262 shown, 59 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 986 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a86212f`
...
## Communities (321 total, 59 thin omitted)
...
Cohesion: 0.10
Nodes (36): contextKey, Session, FromContext(), Context, TokenScope, Load(), LoadFromToken(), T (+28 more)
...
Cohesion: 0.07
Nodes (36): App(), AdminRoute(), ProtectedRoute(), ProfileView(), ProfileViewProps, makeProfile(), renderProfileView(), ProfileViewSkeleton() (+28 more)
...
Cohesion: 0.05
Nodes (33): TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS, TestSuiteItemDialog(), TestSuiteItemDialogMode, TestSuiteItemDialogProps (+25 more)
...
Cohesion: 0.06
Nodes (74): TestSuiteDialog(), BulkActionsBar(), BulkActionsBarProps, ColumnHeaderMenu(), ColumnHeaderMenuProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar() (+66 more)
...
Cohesion: 0.06
Nodes (58): IssueEditor(), PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), UserHoverCardProps, memberSelectLabel(), ISSUE_PRIORITY_LABEL (+50 more)
...
Cohesion: 0.08
Nodes (23): AppToast(), UsernamePicker(), PROJECT_MEMBER_ROLE_LABEL, setToastRef(), InviteMemberDialog(), InviteMemberDialogProps, MintRunnerTokenDialog(), MintRunnerTokenDialogProps (+15 more)
...
Cohesion: 0.05
Nodes (22): member(), profile(), AddCaseToPlanDialog(), AddCaseToPlanDialogProps, PRIORITY_OPTIONS, TestCaseCreateInput, ProjectMemberRepository, TestSuiteRepository (+14 more)
...
Cohesion: 0.09
Nodes (37): mockTokenRepo, TestPlanStatus, Time, Context, ActivityEntry, APITokenIdentity, AttachmentInfo, AutomationJob (+29 more)
...
Cohesion: 0.06
Nodes (34): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, BreadcrumbItem, useProjectAccessGuard(), ownerProfile, renderItems(), useProjectBreadcrumbItems() (+26 more)
...
Cohesion: 0.18
Nodes (9): IssueEditorProps, AttachmentPanelProps, entityAttachmentRepositoryAdapter, createMockEntityAttachmentRepository(), entityAttachmentRepositoryAdapter, entityAttachmentRepository, EntityAttachmentRepository, Attachment (+1 more)
...
Cohesion: 0.07
Nodes (49): describeSystemEvent(), EVENT_TYPE_LABEL, eventTypeLabel(), STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, pathForActivityEntity() (+41 more)
...
Cohesion: 0.13
Nodes (24): CallToolRequest, CallToolResult, Context, ToolAdder, issueRef(), T, TestIsUUID(), TestValidIssueStatus() (+16 more)
...
Cohesion: 0.08
Nodes (20): NotificationPanelProps, createDataSourceResolver(), DataSourceName, createMockNotificationRepository(), createMockProjectMemberRepository(), createMockTestCaseRepository(), createMockTestPlanRepository(), createMockTestSuiteRepository() (+12 more)
...
Cohesion: 0.06
Nodes (40): AppLayout(), AppLayoutInner(), AppMenu(), EnrichedProject, AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar() (+32 more)
...
Cohesion: 0.14
Nodes (10): activityRepository, createMockTestRoleRepository(), testRoleRepositoryAdapter, testRoleRepositoryAdapter, dashboardRepository, TestRoleRepository, notificationRepository, tagRepository (+2 more)
...
## Knowledge Gaps
- **624 isolated node(s):** `UseTableHeightOptions`, `$schema`, `.opencode/plugins/graphify.js`, `ProjectRepository`, `TestCaseRepository` (+619 more)
...
- **Why does `As()` connect `AppTopbar.tsx` to `NewRouter`, `Backend Tag Repository (Postgres)`, `Backend JWT & Auth Service`, `AutomationTools`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `RepoService` connect `Backend Tag Repository (Postgres)` to `Project`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Internal()` connect `Backend Test Plan DB Model (MySQL)` to `Test Run Repository (MySQL+Postgres)`, `Frontend Issue Management UI`, `Backend Profile Repository`, `Backend Issue Domain & Service`, `Backend Test Plan Repository (MySQL)`, `Backend Issue Repository (Postgres)`, `.FindByProjectAndUser`, `Backend Test Case Repository (MySQL)`, `.Create`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `AutomationService`, `Backend Project Membership & Auth Policy`, `Backend JWT & Auth Service`, `Backend Attachment Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `.List`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `Recover`, `AppTopbar.tsx`, `ResultStep`, `RefreshTokenRepository`, `NewRouter`, `AutomationTools`?**
...
- **What connects `UseTableHeightOptions`, `$schema`, `.opencode/plugins/graphify.js` to the rest of the system?**
