# Graph Report - shiftech-test-mgr  (2026-08-09)

## Corpus Check
- 814 files · ~368,971 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4620 nodes · 11115 edges · 319 communities (259 shown, 60 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 986 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b1b75d4`
...
Cohesion: 0.04
Nodes (56): App(), AdminRoute(), ProtectedRoute(), ProfileView(), ProfileViewProps, makeProfile(), renderProfileView(), ProfileViewSkeleton() (+48 more)
...
Cohesion: 0.05
Nodes (76): IssueEditor(), IssueEditorProps, IssueFormData, PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), Breadcrumb() (+68 more)
...
Cohesion: 0.20
Nodes (10): Validation(), computeSummary(), Context, Repository, Summary, TestCaseRepository, TestRun, NewService() (+2 more)

### Community 19 - "Frontend Project Management UI"
Cohesion: 0.06
Nodes (45): BulkActionsBar(), BulkActionsBarProps, dataTablePaginatorProps, dataTablePaginatorTemplate, FilterToolbar(), FilterToolbarProps, RowActionsMenu(), RowActionsMenuProps (+37 more)
...
Cohesion: 0.06
Nodes (28): activityRepository, TestCaseCreateInput, entityAttachmentRepository, IssueRepository, ModuleRepository, issueRepository, moduleRepository, notificationRepository (+20 more)
...
Cohesion: 0.10
Nodes (26): CreateProjectDialog(), CreateProjectDialogProps, DuplicateProjectDialog(), DuplicateProjectDialogProps, EnrichedProject, ProjectsPage(), truncateUsername(), createMockProjectRepository() (+18 more)
...
Cohesion: 0.09
Nodes (21): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS, TestSuiteItemDialog(), TestSuiteItemDialogMode, TestSuiteItemDialogProps (+13 more)
...
Cohesion: 0.26
Nodes (19): T, newFakeRepo(), TestService_Latency_ClampedToZero(), TestService_WithRateLimit_IgnoresZero(), TestService_WithRateLimit_Overrides(), TestService_Wrap_AllHandlersGoverned(), TestService_Wrap_Allowed(), TestService_Wrap_BeginError() (+11 more)
...
Cohesion: 0.09
Nodes (6): MockDashboardSeed, createMockTestSuiteRepository(), TestSuiteRepository, TestSuite, TestSuiteItem, TestSuiteItemStep
...
Cohesion: 0.13
Nodes (17): Error, Kind, As(), Conflict(), fromDomainTestPlan(), Context, DB, TestPlan (+9 more)
...
Cohesion: 0.10
Nodes (36): TestPlanStatus, Time, ActivityEntry, AutomationJob, AutomationJobStatus, AutomationRunner, ExternalLink, Issue (+28 more)
...
Cohesion: 0.07
Nodes (26): UsernamePicker(), member(), profile(), PROJECT_MEMBER_ROLE_LABEL, renderTabParam(), TABS, useTabQueryParam(), InviteMemberDialog() (+18 more)
...
Cohesion: 0.14
Nodes (29): NewIssueService(), T, TestResult, TestRole, newTestIssueContextSources(), TestIssueService_Assign_LogsActivityAndNotifiesNewAssignee(), TestIssueService_UpdateStatus_NoopWhenUnchanged(), TestIssueService_UpdateStatus_NotifiesPreviousAssignee() (+21 more)
...
Cohesion: 0.17
Nodes (13): Context, DB, Next(), fromDomainTestRun(), Context, DB, Status, TestRun (+5 more)

### Community 89 - "Backend Module DB Model (MySQL)"
Cohesion: 0.08
Nodes (20): createDataSourceResolver(), DataSourceName, issueRepositoryAdapter, createMockIssueRepository(), createMockModuleRepository(), createMockProjectMemberRepository(), createMockTestCaseRepository(), createMockTestPlanRepository() (+12 more)

### Community 90 - "Backend Project DB Model (MySQL)"
Cohesion: 0.07
Nodes (44): describeSystemEvent(), EVENT_TYPE_LABEL, eventTypeLabel(), STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, pathForActivityEntity() (+36 more)
...
Cohesion: 0.16
Nodes (13): mapAutomationRunnerRow(), AutomationRunnersTab(), AutomationRunnersTabProps, automationRunnerRepositoryAdapter, createMockAutomationRunnerRepository(), automationRunnerRepositoryAdapter, automationRunnerRepository, AutomationRunnerRepository (+5 more)

### Community 94 - "Backend Attachment DB Model (Postgres)"
Cohesion: 0.16
Nodes (8): createMockTestRunRepository(), sampleRun, TestRunSeed, testRunRepositoryAdapter, testRunRepositoryAdapter, TestRunRepository, TestRunWithPlan, TestRun
...
Cohesion: 0.15
Nodes (13): nonNilLinks(), Context, DB, tagRow, TestCase, TestCaseStep, Time, NewTestCaseRepo() (+5 more)
...
Cohesion: 0.12
Nodes (14): mockTokenRepo, Session, TokenScope, Context, EnsureWriteScope(), Context, TokenScope, APITokenIdentity (+6 more)
...
Cohesion: 0.09
Nodes (28): IssueStatus, StepType, TestCasePriority, TestCaseStatus, TestCase, TestTestCaseServiceUpdateDuplicateArchive(), ActivityRepository, AttachmentRepository (+20 more)
...
Cohesion: 0.19
Nodes (12): errHandler(), CallToolRequest, CallToolResult, Context, isErrorHandler(), okHandler(), beginCall, BeginResult (+4 more)
...
Cohesion: 0.05
Nodes (55): CallToolRequest, CallToolResult, Context, ToolAdder, CallToolRequest, CallToolResult, Context, TokenScope (+47 more)
...
Cohesion: 0.23
Nodes (7): T, TestRequireAuth_RealSupabaseSession(), NewClientFromEnv(), randomPassword(), Request, Client, TestUser

### Community 169 - "main"
Cohesion: 0.21
Nodes (9): jwk, JWKSFetcher, jwksResponse, main(), Duration, Mutex, Time, NewJWKSFetcher() (+1 more)
...
Cohesion: 0.07
Nodes (30): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, ColumnHeaderMenu(), ColumnHeaderMenuProps, PageHeader(), PageHeaderProps (+22 more)

### Community 219 - "RefreshTokenRepository"
Cohesion: 0.33
...
### Community 245 - "supabaseRpcTransport.ts"
Cohesion: 0.27
...
Cohesion: 0.06
Nodes (53): GoogleConfig, googleUserInfo, Service, TokenPair, Forbidden(), Unauthorized(), CanDeleteProject(), CanEditProject() (+45 more)
...
### Community 258 - "main"
Cohesion: 0.23
Nodes (10): authenticateRequest(), governanceInt(), governanceLimit(), governanceWindow(), main(), Context, DB, NewPostgresRepository() (+2 more)
...
Cohesion: 0.13
Nodes (17): MCPServer, ToolAdder, governanceInt(), governanceLimit(), governanceWindow(), main(), toolAdder(), Context (+9 more)
...
Cohesion: 0.27
Nodes (5): Context, IssueHandler, IssueStatus, issueAssignReq, issueUpdateStatusReq
...
### Community 325 - ".FindByProjectAndUser"
Cohesion: 0.47
Nodes (4): Context, DB, NewProjectMemberRepository(), ProjectMemberRepository

### Community 326 - "rest-api/cmd/main.go"
Cohesion: 0.16
Nodes (11): Context, DB, Time, NewAttachmentRepo(), AttachmentRepository, Context, NewAttachmentService(), AttachmentInfo (+3 more)

### Community 328 - "TestPlanStatus"
Cohesion: 0.50
...
## Knowledge Gaps
- **624 isolated node(s):** `EnrichedProject`, `ENTITY_TYPE_OPTIONS`, `AgentTokensTabProps`, `AutomationRunnersTabProps`, `EditableField` (+619 more)
...
- **Why does `As()` connect `Backend Refresh Token Repository (MySQL)` to `NewRouter`, `Backend Tag Repository (Postgres)`, `AutomationTools`, `ResultStep`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `RepoService` connect `Backend Tag Repository (Postgres)` to `Project`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Internal()` connect `Backend Issue Domain & Service` to `Test Run Repository (MySQL+Postgres)`, `Backend Profile Repository`, `Backend Test Plan Repository (MySQL)`, `Backend Issue Repository (Postgres)`, `mockActivityRepo`, `Backend Test Case Repository (MySQL)`, `.Create`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `AutomationService`, `Backend JWT & Auth Service`, `Backend Attachment Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `.List`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `NewTestRoleService`, `.FindByProjectAndUser`, `Backend Test Plan DB Model (MySQL)`, `Backend Attachment DB Model (MySQL)`, `RefreshTokenRepository`, `ResultStep`, `NewRouter`, `AutomationTools`?**
...
- **What connects `EnrichedProject`, `ENTITY_TYPE_OPTIONS`, `AgentTokensTabProps` to the rest of the system?**
