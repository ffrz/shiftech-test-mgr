# Graph Report - shiftech-test-mgr-backend  (2026-08-01)

## Corpus Check
- 629 files · ~293,188 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3368 nodes · 8442 edges · 240 communities (194 shown, 46 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 700 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31b797d1`
...
## Communities (240 total, 46 thin omitted)

### Community 0 - "Test Run Repository (MySQL+Postgres)"
Cohesion: 0.10
Nodes (27): NotFound(), Time, fromDomainTestRun(), Context, DB, Status, TestResult, TestResultStep (+19 more)

### Community 1 - "Frontend Repository/Mapper Layer"
Cohesion: 0.16
Nodes (11): ModuleDialog(), ModuleDialogProps, TagDialog(), TagDialogProps, TestRoleDialog(), TestRoleDialogProps, ProjectSettingsPageSkeleton(), MembersTab() (+3 more)
...
Cohesion: 0.10
Nodes (30): AppLayout(), AppLayoutInner(), AppSidebar(), AppSidebarMask(), AppTopbar(), getUserInitial(), pathForNotification(), BreadcrumbContext (+22 more)

### Community 6 - "Frontend Package Dependencies"
Cohesion: 0.09
Nodes (23): devDependencies, jsdom, oxlint, sharp, @testing-library/jest-dom, @testing-library/react, @types/node, @types/react (+15 more)

### Community 7 - "Frontend Issue Management UI"
Cohesion: 0.06
Nodes (43): App(), AdminRoute(), ProtectedRoute(), AppToast(), BreadcrumbItem, setToastRef(), AuthProvider(), useAuthContext() (+35 more)

### Community 8 - "Frontend Auth & User Settings"
Cohesion: 0.05
Nodes (44): ActivityPanel(), ActivityPanelProps, ActivityPanelSkeleton(), AttachmentPanel(), CommentEditor(), CommentEditorProps, MarkdownPreview(), MarkdownPreviewProps (+36 more)

### Community 9 - "Frontend Test Case UI"
Cohesion: 0.09
Nodes (23): date-fns, dependencies, date-fns, @hookform/resolvers, primeflex, primeicons, primereact, react-hook-form (+15 more)

### Community 10 - "Frontend Routes & Pages"
Cohesion: 0.07
Nodes (30): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS (+22 more)

### Community 11 - "Frontend Test Run/Plan Detail UI"
Cohesion: 0.07
Nodes (61): TestSuiteDialog(), Breadcrumb(), BreadcrumbProps, BulkActionsBar(), BulkActionsBarProps, ColumnHeaderMenu(), ColumnHeaderMenuProps, dataTablePaginatorProps (+53 more)
...
Cohesion: 0.20
Nodes (9): computeSummary(), Repository, Summary, TestCaseRepository, NewService(), Repository, TestCaseRepository, TestPlanCaseRepository (+1 more)
...
Cohesion: 0.07
Nodes (33): AppMenu(), EnrichedProject, AppMenuitem(), AppMenuSeparator(), MenuItemModel, OwnerProjectLabel(), OwnerProjectLabelProps, truncate() (+25 more)
...
Cohesion: 0.07
Nodes (52): TestPlanStatus, Time, CallToolRequest, CallToolResult, Context, MCPServer, isUUID(), T (+44 more)

### Community 30 - "AGENTS.md Conventions"
Cohesion: 0.13
Nodes (19): Clean Architecture Layering (Repository→Service→Hook→Component), Google OAuth Setup Steps, Module Creation Order convention, PageHeader Convention (Judul Halaman), TestManager (shiftech-test-mgr), UI Architecture - PrimeReact, Naming & Convention rules, PrimeReact UI Library Usage (+11 more)

### Community 31 - "Backend App Error Types"
Cohesion: 0.11
Nodes (30): mapActivityEntryRow(), mapAttachmentRow(), mapExternalLinks(), mapIssueRow(), mapModuleRow(), mapNotificationRow(), mapProfileRow(), mapProjectMemberInvitationRow() (+22 more)
...
Cohesion: 0.09
Nodes (38): ProfileView(), ProfileViewSkeleton(), EVENT_TYPE_LABEL, STATUS_LABEL_BY_ENTITY, ISSUE_STATUS_SEVERITY, ISSUE_TYPE_SEVERITY, PROJECT_MEMBER_ROLE_LABEL, PROJECT_MEMBER_ROLE_SEVERITY (+30 more)
...
Cohesion: 0.07
Nodes (25): TestRun, TestRun, TestTestRunServiceCreateRecordComplete(), Context, TestRun, NewTestRunService(), CreateTestRunInput, IssueRepository (+17 more)
...
Cohesion: 0.17
Nodes (9): supabase, mapUserRow(), AuthContextValue, createMockUserRepository(), userRepositoryAdapter, userRepositoryAdapter, UserRepository, User (+1 more)
...
Cohesion: 0.08
Nodes (14): dashboardRepositoryAdapter, createMockDashboardRepository(), createMockTestPlanRepository(), dashboardRepositoryAdapter, testPlanRepositoryAdapter, dashboardRepository, ContinueWorkingItem, DashboardCounts (+6 more)
...
Cohesion: 0.12
Nodes (17): createDataSourceResolver(), DataSourceName, createMockTestCaseRepository(), createMockTestCaseStepRepository(), createMockTestResultRepository(), sampleResult, sampleResultWithSteps, createMockTestRunRepository() (+9 more)

### Community 75 - "Backend Test Run DB Model (MySQL)"
Cohesion: 0.14
Nodes (13): T, TestPlanStatus, TestPlan, TestTestPlanServiceCreateAddRemoveApprove(), Context, TestPlan, NewTestPlanService(), CreateTestPlanInput (+5 more)
...
Cohesion: 0.17
Nodes (10): Context, Issue, IssueStatus, TestCase, TestPlan, CreateTestCaseInput, UpdateTestCaseInput, writeMockIssueRepo (+2 more)

### Community 78 - "Backend Test Case DB Model (Postgres)"
Cohesion: 0.16
Nodes (14): Context, Module, Project, Tag, TestCase, TestTestCaseServiceUpdateDuplicateArchive(), ProjectFilter, TestCaseFilter (+6 more)
...
Cohesion: 0.16
Nodes (10): mockTokenRepo, Session, Context, EnsureWriteScope(), Context, APITokenIdentity, TokenScope, Registry (+2 more)
...
Cohesion: 0.19
Nodes (9): Context, DB, TestPlan, Time, NewTestPlanRepo(), TestPlanStatus, testPlanCaseRow, TestPlanRepo (+1 more)
...
Cohesion: 0.18
Nodes (15): Context, DB, Time, NewTokenRepo(), sha256Hex(), T, TestSha256Hex(), TestSha256HexDeterministic() (+7 more)
...
Cohesion: 0.17
Nodes (15): describeSystemEvent(), eventTypeLabel(), statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, pathForActivityEntity(), useDashboard(), useProjectInvitations() (+7 more)
...
Cohesion: 0.19
Nodes (7): sampleRun, TestRunSeed, testRunRepositoryAdapter, TestRunRepository, TestRunWithPlan, TestRun, TestRunStatus
...
Cohesion: 0.33
Nodes (5): Context, TestCase, TestCaseStep, newUUID(), TestCaseRepo
...
Cohesion: 0.24
Nodes (6): UsernamePickerProps, createMockProfileRepository(), profileRepositoryAdapter, profileRepositoryAdapter, ProfileRepository, Profile
...
Cohesion: 0.07
Nodes (48): IssueEditor(), PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY, ISSUE_STATUS_LABEL, ISSUE_TYPE_LABEL (+40 more)
...
Cohesion: 0.12
Nodes (16): Backend Go — Task Breakdown (siap eksekusi per-agen), Fase 1 — Database Prasyarat, Fase 3 — MCP Read Tools, Fase 5 — Automation, Analysis, Repo Tools, Fase 7 — REST API, Fase 8 — AI Gateway (defer), T1.1 — Migration `api_tokens`, T1.2 — Migration `mcp_tool_rate_limits` + RPC governance (+8 more)
...
Cohesion: 0.09
Nodes (10): ProfileViewProps, MockDashboardSeed, createMockTestSuiteRepository(), testSuiteRepositoryAdapter, testSuiteRepositoryAdapter, TestSuiteRepository, TestSuite, TestSuiteItem (+2 more)
...
### Community 150 - "react-markdown"
Cohesion: 0.29
Nodes (8): IssueStatus, Issue, IssueStatus, CreateIssueInput, IssueFilter, IssueType, mockIssueRepo, TestCasePriority

### Community 166 - "main"
Cohesion: 0.24
Nodes (8): authenticateRequest(), main(), Context, Tag, NewTagService(), HTTPContextFunc, TagService, TagRepository
...
Cohesion: 0.20
Nodes (7): DB, tagRow, Time, NewTestCaseRepo(), testCaseRow, testCaseStepRow, testCaseTagRow
...
### Community 173 - "main"
Cohesion: 0.29
Nodes (6): main(), Context, Module, NewModuleService(), ModuleRepository, ModuleService
...
Cohesion: 0.29
Nodes (8): Layered Architecture Flow (Page→Hook→Service→Repository→Supabase), React Query + Supabase Realtime Data Freshness (E14), System Architecture - Client-side SPA, API Boundary Proposal for future Go backend, Frontend Layered Structure, Why No Controller/API Layer, Technology Independence principle, Infrastructure Feature Checklist
...
### Community 187 - "NewTestResultService"
Cohesion: 0.39
...
Cohesion: 0.40
Nodes (5): Fase 4 — Write Tools + Governance, T4.1 — File baru `write_tools.go` — ✅ DONE (2026-08-01), T4.2 — Governance middleware (rate-limit + audit) — ⛔ BLOCKED, T4.3 — Project-scope recursive guard — ✅ DONE (2026-08-01), T4.4 — Aktifkan write tools di registry — ✅ DONE (2026-08-01)
...
## Knowledge Gaps
- **437 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `ProjectRepository`, `TestCaseRepository`, `TestPlanRepository` (+432 more)
...
- **Why does `Internal()` connect `Backend Issue Domain & Service` to `Test Run Repository (MySQL+Postgres)`, `.Update`, `Created`, `Backend Profile Repository`, `Frontend Project Management UI`, `Backend Test Plan Repository (MySQL)`, `Backend Test Plan Repository (Postgres)`, `Backend Issue Repository (Postgres)`, `Backend Google OAuth Service`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `Backend Module Repository (MySQL)`, `Backend Project Membership & Auth Policy`, `Backend JWT & Auth Service`, `Backend Test Role Repository (MySQL)`, `Backend Attachment Repository (MySQL)`, `Backend Tag Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `Backend HTTP Response Helpers`, `Recover`, `Backend Test Plan DB Model (MySQL)`, `Backend Test Case Snapshot Model (MySQL)`, `ResultStep`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `Validation()` connect `Backend Test Run Service` to `Backend Test Plan Service`, `Test Case Backend (Domain+Service+Repo)`, `Created`, `Backend Project Service`, `Backend Issue HTTP Layer`, `Backend Attachment HTTP DTO`, `Backend Test Plan HTTP Layer`, `Backend Project HTTP Layer`, `Backend Module Service`, `Backend Auth HTTP Handler`, `Backend Issue Repository (MySQL)`, `Backend Test Run HTTP Layer`, `Backend Attachment Service`, `Backend Tag Service`, `Backend Test Role Service`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `BindAndValidate()` connect `Backend Project HTTP Layer` to `Backend Auth HTTP DTO`, `Backend Module HTTP DTO`, `Backend Tag HTTP DTO`, `Backend Test Role HTTP DTO`, `Backend Issue HTTP Layer`, `Backend Attachment HTTP DTO`, `Backend Test Plan HTTP Layer`, `Backend Test Run Service`, `Backend Issue Repository (MySQL)`, `Backend Test Run HTTP Layer`?**
