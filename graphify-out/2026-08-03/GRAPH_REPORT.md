...
## Corpus Check
- 812 files · ~365,966 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4580 nodes · 10994 edges · 357 communities (276 shown, 81 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 854 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98f031c2`
...
## Communities (357 total, 81 thin omitted)

### Community 0 - "Test Run Repository (MySQL+Postgres)"
Cohesion: 0.10
Nodes (27): Time, fromDomainTestRun(), Context, DB, Status, TestResult, TestResultStep, TestRun (+19 more)
...
Cohesion: 0.06
Nodes (38): App(), AdminRoute(), ProtectedRoute(), TestSuiteItemDialog(), AppTopbar(), getUserInitial(), pathForNotification(), useBreadcrumbContext() (+30 more)

### Community 8 - "Frontend Auth & User Settings"
Cohesion: 0.11
Nodes (18): ActivityPanel(), ActivityPanelProps, ActivityPanelSkeleton(), CommentEditor(), CommentEditorProps, MarkdownPreview(), MarkdownPreviewProps, MentionTextarea() (+10 more)
...
Cohesion: 0.07
Nodes (26): UsernamePicker(), buildUsagePromptStarters(), useAutomationRunners(), CreateProjectDialog(), InviteMemberDialog(), InviteMemberDialogProps, ACCESS_LEVEL_OPTIONS, MCP_SERVER_URL (+18 more)
...
Cohesion: 0.09
Nodes (28): FromTestPlan(), FromTestPlanCase(), FromTestPlanCases(), FromTestPlans(), TestPlan, Time, Context, Service (+20 more)
...
Cohesion: 0.10
Nodes (36): IssueEditor(), PRIORITY_OPTIONS, STATUS_OPTIONS, TYPE_OPTIONS, AttachmentPanel(), memberSelectLabel(), ISSUE_PRIORITY_LABEL, ISSUE_PRIORITY_SEVERITY (+28 more)
...
Cohesion: 0.23
Nodes (10): Conflict(), fromDomainTestPlan(), Context, DB, TestPlan, TestPlanCase, NewTestPlanRepository(), toDomainTestPlan() (+2 more)
...
Cohesion: 0.06
Nodes (31): ProfileViewProps, makeProfile(), renderProfileView(), UsernamePickerProps, member(), profile(), AuthContextValue, CreateProjectDialogProps (+23 more)
...
Cohesion: 0.21
Nodes (14): boolLiteral(), decodeCaseBatch(), Context, ToolAdder, requireUUIDSlice(), reviewOnly(), validIssueType(), CallToolRequest (+6 more)
...
Cohesion: 0.05
Nodes (55): STATUS_OPTIONS, TestPlanDialog(), TestPlanDialogProps, PRIORITY_OPTIONS, STEP_TYPE_OPTIONS, TestSuiteItemDialogMode, TestSuiteItemDialogProps, IssueEditorProps (+47 more)
...
Cohesion: 0.21
Nodes (11): fromDomainTestRun(), Context, DB, Status, TestResult, TestRun, NewTestRunRepository(), toDomainTestResult() (+3 more)
...
Cohesion: 0.17
Nodes (13): isDuplicateKeyErr(), Context, DB, Tag, NewTagRepository(), toDomainTag(), Context, DB (+5 more)
...
Cohesion: 0.09
Nodes (6): createMockTestSuiteRepository(), testSuiteRepositoryAdapter, TestSuiteRepository, TestSuite, TestSuiteItem, TestSuiteItemStep
...
Cohesion: 0.22
Nodes (12): Context, assertContained(), assertRepoRevision(), gitCredentialEnv(), Context, NewRepoService(), safeRepoURL(), validateRepoLimit() (+4 more)
...
Cohesion: 0.13
Nodes (28): Time, ActivityEntry, AnalysisProblematicResult, AnalysisRunSummary, AutomationJob, AutomationJobStatus, AutomationRunner, CanCloseResult (+20 more)
...
Cohesion: 0.09
Nodes (24): useProjectAccessGuard(), ownerProfile, renderItems(), useProjectBreadcrumbItems(), otherProfile, renderOwner(), useProjectOwnerProfile(), renderRole() (+16 more)
...
Cohesion: 0.16
Nodes (28): Load(), LoadFromToken(), T, TestAssertProjectReferences_ArrayElements(), TestAssertProjectReferences_CamelCaseMatch(), TestAssertProjectReferences_Mismatch(), TestAssertProjectReferences_NestedObject(), TestAssertProjectReferences_NestedObjectAllMatch() (+20 more)

### Community 74 - "Backend Test Case DB Model (MySQL)"
Cohesion: 0.10
Nodes (19): queryKeys, useTestPlanDetail(), EMPTY_SUMMARY, Summary, useTestRuns(), StartTestRunDialog(), StartTestRunDialogProps, PlanTestCasesTab() (+11 more)
...
Cohesion: 0.14
Nodes (16): Context, Context, DB, StringArray, TestCasePriority, Time, NewAnalysisRepo(), round2() (+8 more)
...
Cohesion: 0.16
Nodes (11): contextKey, Session, FromContext(), Context, TokenScope, TestWithSessionFromContext(), WithSession(), EnsureWriteScope() (+3 more)
...
Cohesion: 0.16
Nodes (17): describeSystemEvent(), EVENT_TYPE_LABEL, eventTypeLabel(), STATUS_LABEL_BY_ENTITY, statusLabel(), ACTIVITY_ENTITY_LABEL, ACTIVITY_ENTITY_ROUTE, pathForActivityEntity() (+9 more)
...
Cohesion: 0.09
Nodes (30): iconForType(), NOTIFICATION_TYPE_ICON, NotificationPanel(), ProfileView(), RelativeTime(), RelativeTimeProps, ONE_MIN_AGO, ISSUE_STATUS_SEVERITY (+22 more)
...
Cohesion: 0.18
Nodes (9): createMockTestRunRepository(), sampleRun, TestRunSeed, testRunRepositoryAdapter, testRunRepositoryAdapter, TestRunRepository, TestRunWithPlan, TestRun (+1 more)

### Community 95 - "Backend Module DB Model (Postgres)"
Cohesion: 0.11
Nodes (22): validStepType(), TestCase, ActivityRepository, AttachmentRepository, CreateTestCaseInput, IssueRepository, ModuleRepository, NotificationRepository (+14 more)
...
Cohesion: 0.09
Nodes (19): AttachmentPanelProps, createDataSourceResolver(), DataSourceName, entityAttachmentRepositoryAdapter, createMockEntityAttachmentRepository(), createMockTestCaseRepository(), createMockTestPlanRepository(), entityAttachmentRepositoryAdapter (+11 more)
...
Cohesion: 0.07
Nodes (22): activityRepository, activityRepositoryAdapter, dashboardRepositoryAdapter, createMockActivityRepository(), createMockDashboardRepository(), MockDashboardSeed, activityRepositoryAdapter, dashboardRepositoryAdapter (+14 more)
...
Cohesion: 0.11
Nodes (18): ActivityEntry, Context, Issue, Module, Profile, Tag, TestCase, TestTestCaseServiceUpdateDuplicateArchive() (+10 more)

### Community 141 - "@tanstack/react-query"
Cohesion: 0.16
Nodes (10): Context, ProjectHandler, Context, Project, NewProjectService(), Project, ProjectFilter, ProjectRepository (+2 more)

### Community 142 - "ProjectMemberRepository"
Cohesion: 0.11
Nodes (13): ActivityEntry, Context, Issue, IssueStatus, Profile, TestPlan, TestPlanStatus, TestResult (+5 more)
...
Cohesion: 0.12
Nodes (5): makeTestCase(), nextId(), TestCaseRepository, TestCase, TestPlanCase
...
Cohesion: 0.28
Nodes (8): CallToolRequest, CallToolResult, Context, ToolAdder, issueRef(), isUUID(), validLimit(), ReadTools
...
### Community 173 - "main"
Cohesion: 0.12
Nodes (11): TestRun, TestRun, TestTestRunServiceCreateRecordComplete(), CreateTestRunInput, PageResult, RecordResultInput, RunSummary, TestRunFilter (+3 more)
...
Cohesion: 0.15
Nodes (13): validIssuePriority(), validIssueStatus(), Context, DB, Time, NewIssueRepo(), Issue, IssuePriority (+5 more)
...
Cohesion: 0.05
Nodes (69): TestSuiteDialog(), TestSuiteDialogMode, TestSuiteDialogProps, VISIBILITY_OPTIONS, BulkActionsBar(), BulkActionsBarProps, ColumnHeaderMenu(), ColumnHeaderMenuProps (+61 more)
...
Cohesion: 0.24
Nodes (7): Context, DB, NewNotificationRepo(), CreateNotificationInput, NotificationRepo, mockNotificationRepo, writeMockNotificationRepo
...
Cohesion: 0.09
Nodes (29): AppLayout(), AppLayoutInner(), AppMenu(), EnrichedProject, AppMenuitem(), AppMenuSeparator(), MenuItemModel, AppSidebar() (+21 more)
...
Cohesion: 0.13
Nodes (13): Context, DB, Time, NewAttachmentRepo(), AttachmentRepository, Context, NewAttachmentService(), AttachmentInfo (+5 more)
...
Cohesion: 0.27
Nodes (5): TestPlan, TestPlanStatus, TestTestPlanServiceCreateAddRemoveApprove(), CreateTestPlanInput, mockTestPlanRepo
...
### Community 352 - "TestCaseSnapshotRepository"
Cohesion: 0.36
Nodes (6): Context, DB, NewTestCaseSnapshotRepository(), NewTestPlanCaseReader(), TestCaseSnapshotRepository, TestPlanCaseReader

### Community 353 - ".toDomain"
Cohesion: 0.31
Nodes (6): Context, DB, NewRepoRepo(), RepositorySourceType, projectRepositoryRow, RepoRepo

### Community 354 - "Profile"
Cohesion: 0.36
Nodes (4): Time, Profile, RefreshToken, Role

### Community 355 - "APITokenIdentity"
Cohesion: 0.53
Nodes (4): mockTokenRepo, Context, APITokenIdentity, TokenScope

## Knowledge Gaps
- **621 isolated node(s):** `MembersTabProps`, `ProjectRepository`, `TestCaseRepository`, `TestPlanRepository`, `TestRunRepository` (+616 more)
...
- **Why does `As()` connect `AppLayout.tsx` to `Backend Test Plan HTTP Layer`, `Backend JWT & Auth Service`, `Backend Test Role Repository (MySQL)`, `NewRouter`, `Backend Tag Repository (Postgres)`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `ProjectRepositoryConfig` connect `Backend Tag Repository (Postgres)` to `Backend RBAC Middleware`, `.toDomain`, `Backend Test Role Service`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Internal()` connect `Backend Test Plan DB Model (MySQL)` to `Test Run Repository (MySQL+Postgres)`, `Backend Profile Repository`, `Backend Issue Domain & Service`, `Backend Test Plan Repository (MySQL)`, `.Update`, `Backend Issue Repository (Postgres)`, `mockActivityRepo`, `Backend Test Case Repository (MySQL)`, `Backend Project Repository (MySQL)`, `Backend Project Repository (Postgres)`, `Backend Project Membership & Auth Policy`, `Backend JWT & Auth Service`, `Backend Test Role Repository (MySQL)`, `Backend Attachment Repository (MySQL)`, `Backend Attachment Repository (Postgres)`, `.List`, `Backend Refresh Token Repository (MySQL)`, `Backend Refresh Token Repository (Postgres)`, `Recover`, `TestCaseSnapshotRepository`, `ResultStep`, `NewRouter`, `AutomationTools`, `AppLayout.tsx`?**
...
- **What connects `MembersTabProps`, `ProjectRepository`, `TestCaseRepository` to the rest of the system?**
