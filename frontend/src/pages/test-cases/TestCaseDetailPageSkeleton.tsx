...
// Loading placeholder for the Test Case detail page — mirrors its layout (header
// card with code/title + meta + stat tiles, then the objective/preconditions/steps
// content cards) so the page doesn't flash a blank screen while the case loads.
// Shared by both entry points (from project test-cases tab and from test suite).
export function TestCaseDetailPageSkeleton() {
  return (
